...
const dashboardRoutes = require("./routes/admin.js");
...
app.use(express.static(path.join(__dirname, "public"))); // ou ../public
...
// Página de curso detalhe (com parâmetro de query)
app.get("/Cursodetalhe.html", (req, res) => {
    res.sendFile(path.join(__dirname, "public", "Cursodetalhe.html"));
});

// Página de artigo
app.get("/artigodetalhe.html", (req, res) => {
    res.sendFile(path.join(__dirname, "public", "artigodetalhe.html"));
});

// Outras páginas (cursos, contato, etc.)
app.get("/cursos.html", (req, res) => {
    res.sendFile(path.join(__dirname, "public", "cursos.html"));
});

// Rota fallback opcional (404)
app.get("*", (req, res) => {
