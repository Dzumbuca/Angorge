...
const Artigo = require("../models/Artigo");          // caminho correto
const Curso = require("../models/Curso");            // caminho correto para o teu modelo de curso
const Inscrito = require("../models/Curso");      // caminho correto para inscritos
